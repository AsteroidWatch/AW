...
public class Asteroids {
    ...
    public static LocalDate setStartDate(String startDate) {
        LocalDate s = LocalDate.parse(startDate);

        return s;
    }

    public static LocalDate setEndDate(String endDate) {
        return LocalDate.parse(endDate);
    }

    public static ArrayList<AsteroidFetch> returnAsteroids()  {
        // TODO Auto-generated method stub
        Instant start = Instant.now();
        System.out.println("Start time: " + Calendar.getInstance().getTime());
        LocalDate START_DATE = setStartDate("1999-01-01");
        LocalDate END_DATE = setEndDate("2011-01-09");
