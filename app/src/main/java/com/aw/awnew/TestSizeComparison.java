...
public class TestSizeComparison extends SimpleApplication {
	...
	ArrayList<ComparisonAsteroid> getAsteroids() {
		ArrayList<Asteroid> roids = SearchActivity.asteroids;
		...
		for (int i = 1; i < count; i++) {
			...
			ComparisonAsteroid asteroid = new ComparisonAsteroid(roids.get(i - 1).name, size, model, assetManager);
